...
\lstset{numbers=left, numberstyle=\small, numbersep=8pt, frame = single, language=python, framexleftmargin=15pt}
...
\lstset{literate=
  ...
  {»}{{\guillemotright}}1 {ñ}{{\~n}}1 {Ñ}{{\~N}}1 {¿}{{?`}}1{ÿ}{{\"y}}1
}
...
\author{\nombre}
\tutor{Dr. César Ignacio García-Osorio\\ y Dr. Carlos López Nozal}
\date{\today}
...
\noindent D. César Ignacio García-Osorio y D. Carlos López Nozal, profesores del departamento de Ingeniería Civil, área de Lenguajes y Sistemas Informáticos.
