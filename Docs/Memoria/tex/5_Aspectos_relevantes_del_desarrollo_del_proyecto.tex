...
\imagen{logo_login}{Logo de \emph{SurveyingPointCode}}
...
Al final, se dedujo que se podía tratar de un problema de codificación del archivo, e investigando en esa linea decidimos probar dos configuraciones, \texttt{UTF-8} y \texttt{Latin-1}, en los 2 sistemas , y en cada uno sucedía lo contrario, como se puede ver en la Tabla Tabla~\ref{tabla:WL}
...
\imagen{colores_cad}{Diez primeros colores en la paleta de colores CAD}
...
\imagen{cad_versions_ok}{Versiones de CAD aceptadas por \emph{SurveyingPointCode}}
...
\tablaSmall{Servicios incluidos en \texttt{docker-compose.yml}}{l c c c
}{dockercompose}
{ \multicolumn{1}{l}{Servicio} & Imagen & 
Contenedor & Puerto \\}{ 
